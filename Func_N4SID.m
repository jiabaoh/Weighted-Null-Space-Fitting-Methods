function [A,B,C,D,K,Ro,AUX,ss] = Func_N4SID(y,u,i,n,AUXin,W,sil);
% 
...
if isempty(u)  % Check if u is an empty array
...
% Determine the number of columns in the Hankel matrices, here it thinks f
% = p
j = ny-2*i+1;
